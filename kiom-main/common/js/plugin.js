    ...
    $.extend(Plugin.prototype, {
        ...
        helper: {
            ...
            calculateTimeFromMinutes: function (min) {
                ...
                return (
                    (hours > 11 ? '<em>오후</em>' : '<em>오전</em>') +
                    (hours < 10 ? '<span class="zero">0</span>' : '') +
                    '<span class="clock">' +
                    hours +
                    '<span class="t_txt">시간</span>' +
                    '</span>' +
                    '<span class="s_txt">:</span>' +
                    (minutes < 10 ? '<span class="zero">0</span>' : '') +
                    '<span class="clock">' +
                    minutes +
                    '<span class="t_txt"> 분</span>' +
                    '</span>'
                );
            },
        ...
        init: function () {
            ...
            var drawHandles = function () {
                ...
                circles
                    .html(
                        '<pattern id="img1"  width="40" height="40"><image href="../common/images/sub/icon_circle_01.png" x="0" y="0" width="40" height="40" /></pattern>'
                    )
                    .append('circle')
            ...
            this.graph.svg = d3
                ...
                .append('svg')
                .html(
                    '<linearGradient id="MyGradient"><stop offset="0%" stop-color="#b36fde" /><stop offset="100%" stop-color="#17bdcc" /></linearGradient>'
                )
                ...
                .attr(
                    'transform',
                    'translate(' +
                        ((this.settings.width + this.settings.offset - this.settings.width) / 2 + margin.top) +
                        ',' +
                        ((this.settings.height + this.settings.offset - this.settings.height) / 2 + margin.left) +
                        ')'
                );
            ...
            ringbgrd
                .html(
                    '<pattern id="img2"  width="40" height="40"><image href="../common/images/sub/icon_circle_02.png" x="0" y="0" width="40" height="40" /></pattern>'
                )
                .append('circle')
                .attr('r', radius)
                .attr('class', 'ringbgrd')
        ...
        drawClockTicks: function () {
            ...
            ticks
                ...
                .attr('dy', '.35em')
                .attr('transform', function (d) {
                    return d.angle > 180 ? 'rotate(180)translate(-16)' : 'rotate(0)translate(7)';
                })
