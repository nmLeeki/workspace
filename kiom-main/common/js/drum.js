...
(function ($) {
        ...
        return {
            up: function (settings) {
                ...
                $(p).attr(
                    'd',
                    'm0,' +
                        (height + settings.dail_stroke_width) +
                        'l' +
                        width / 2 +
                        ',-' +
                        height +
    ...
    var Drum = function (element, options, transformProp) {
        ...
        if (settings.transformProp) {
            ...
            else if (HTMLselect.id) $(wrapper).attr('id', 'drum_' + HTMLselect.id);
            else if ($(HTMLselect).attr('name')) $(wrapper).attr('id', 'drum_' + $(HTMLselect).attr('name'));
            ...
            var transform = function (fire_event) {
                $(drum).css(
                    settings.transformProp,
                    'translateZ(-' + settings.radius + 'px) ' + settings.rotateFn + '(' + settings.rotation + 'deg)'
                );
                ...
                if (selected) {
                    ...
                    $(selected.elem).css('font-weight', 500);
        ...
        this.getIndex = function () {
            if (settings.transformProp) return getSelected().dataModel.index;
